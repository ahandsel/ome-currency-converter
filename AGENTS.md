...
The app runs on [Nuxt](https://nuxt.com/) 4, the full-stack Vue framework. Phases 0 to 4 of [docs/technical-plan.md](docs/technical-plan.md) are complete: Nuxt migration, curated photo backgrounds, the home/travel increment-table wallpaper, center/left positioning, and English/Japanese localization. Phase 5 (polish and deployment) is still pending.

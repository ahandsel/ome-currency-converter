...
4. Refer to the repository style guides under [`docs/`](../docs/) (in particular `general-style-guide-english.md`) for guidance on tone, style, terminology, and formatting.

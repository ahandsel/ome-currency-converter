...
* [utils/ladder.js](utils/ladder.js) - pure `buildLadder({ step, rowCount, includeOne })` helper that builds the home-amount row list for the increment-table wallpaper.

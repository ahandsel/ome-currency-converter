...
* [wallpaper.js](wallpaper.js) - the pure canvas renderer. It exports `DEVICE_SIZES`, `THEMES`, and `renderWallpaper`. It paints a cover-fit photo or gradient theme, then the two-column increment table (left = home amounts, right = travel amounts). Incomplete home/travel data paints the background only and does not invent amounts.

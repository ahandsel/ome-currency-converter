...
2. `docs/technical-style-guide-english.md` - help-documentation rules. These supplement and take precedence over the general guide for how-to guides, reference documents, tutorials, and explanations. This repository does not currently include this guide; skip this step when the file is absent.
